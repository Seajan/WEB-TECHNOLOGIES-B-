	...
	<body>
		...
		<nav class="sidebar">
			...
			<ul class="pop">
				...
				<li><a href="booking_schedule.php"><i class="fas fa-list"></i>Schedule</a></li>	
				<li><a href="Booking_Ticket.php"><i class="far fa-clipboard"></i>Booking_Ticket </a></li>
				<li><a href="about.php"><i class="fas fa-list"></i>About_Us</a></li>	
				<li><a href="Contact.php"><i class="far fa-clipboard"></i>Contut_Us </a></li>
