	...
	<body>
		...
		<nav class="sidebar">
			...
			<ul class="pop">
				...
				<li><a href="showStudents.php"><i class="fas fa-list"></i>Students List</a></li>	
				<li><a href="#"><i class="fas fa-book"></i>Course<span class="sub_arrow"></span></a>
					<ul>
							<li><a href="mycourse.php"><i class="fas fa-address-card"></i>My Course</a></li>
							<li><a href="course.php"><i class="fas fa-user-edit"></i>Enroll Student</a></li>
					</ul>
				</li>	
				<li><a href="grade.php"><i class="fas fa-list"></i>Grade</a></li>	
				<li><a href="note.php"><i class="far fa-clipboard"></i>Notes</a></li>
